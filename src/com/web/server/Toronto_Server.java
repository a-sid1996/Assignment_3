...
import com.web.service.impl.Toronto_Class;
...
public class Toronto_Server {
	...
	public static Toronto_Class stub3;
	...
	public static void main(String args[]) throws Exception {
		...
		stub3 = new Toronto_Class();
		Endpoint endpoint = Endpoint.publish("http://localhost:8082/toronto", stub3);
